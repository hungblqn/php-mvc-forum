<?php
	class QuanLyBaiVietView{
		...
		public function HienThiKetQuaThichBaiViet($ketqua){
			if($ketqua == true){
				//echo '<div class="container my-5 bg-success text-white"><br><h2 align="center"></h2><br></div>';
				//header("Location: ");
			}
			else{
				//echo '<div class="container my-5 bg-danger text-white"><br><h2 align="center"></h2><br></div>';
			}
		}
	}
?>